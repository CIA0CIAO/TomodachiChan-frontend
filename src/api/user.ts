...
export function loginByVerificationCode(email: string, verificationCode: string) {
...
export function updateEmail(email: string, verificationCode: string) {
  return $axios.put<RespStr>('/user/account/email', {
    email, verificationCode,
  })
}
